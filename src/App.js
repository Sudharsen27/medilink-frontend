...
//           <Route
//             path="/data-backup"
//             element={user ? <DataBackup /> : <Navigate to="/login" />}
//           />
...
// // FINAL WRAPPER with ALL PROVIDERS
// export default function AppWrapper() {
//   return (
//     <ToastProvider>
//       <FavoritesProvider>
...
// import { NotificationsProvider } from './context/NotificationsContext';
// import { ActivityProvider } from './context/ActivityContext';
// import { MedicalRecordsProvider } from './context/MedicalRecordsContext'; // ⭐ ADDED
...
//           <Route path="/register" element={user ? <Navigate to="/dashboard" /> : <Register onSuccess={() => navigate('/login')} />} />
...
// // ===========================================
// // ⭐ FINAL APP WRAPPER (ALL PROVIDERS)
// // ===========================================
// export default function AppWrapper() {
//   return (
//     <ToastProvider>
...
//         <ActivityProvider>
//           <NotificationsProvider>
//             <MedicalRecordsProvider>     {/* ⭐ FIXED — ADDED HERE */}
//               <App />
