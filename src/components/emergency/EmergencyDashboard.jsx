...
const EmergencyDashboard = () => {
  ...
  return (
    <PageContainer maxWidth="max-w-3xl" className="pb-8">
      <div className="mb-6">
      ...
      {/* Status bar */}
      <Card padding="sm" className="!p-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            {currentLocation ? (
              ...
              <>
                ...
                <span className="text-xs text-slate-500">Location required</span>
      ...
      {/* SOS */}
      <Card padding="lg" className="!p-6 sm:!p-8 mb-6 text-center border-rose-200/40 dark:border-rose-900/30">
        <h2 className="text-xl font-display font-bold text-rose-600 dark:text-rose-400 mb-1">
          Emergency SOS
        </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {QUICK_ACTIONS.map((action, i) => (
            <motion.button
              ...
              className={`p-4 rounded-xl border text-left transition-all hover:shadow-soft hover:-translate-y-0.5 ${action.accent}`}
            >
