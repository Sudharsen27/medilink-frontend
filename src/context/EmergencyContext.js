...
//         setEmergencyContacts(contactsData.data || contactsData.contacts || []);
//       }
...
//                 message: `EMERGENCY ALERT: ${localStorage.getItem('userName') || 'User'} has triggered an emergency SOS. Location: ${currentLocation ? `https://maps.google.com/?q=${currentLocation.latitude},${currentLocation.longitude}` : 'Location not available'}. Please check immediately.`
//               }),
//             })
//           )
//       );
...
//   const connectEmergencyDoctor = async () => {
//     try {
//       const token = localStorage.getItem('token');
...
//   const dispatchAmbulance = async (hospitalId = null) => {
//     try {
//       const token = localStorage.getItem('token');
...
//   const updateMedicalInfo = async (infoData) => {
//     try {
//       const token = localStorage.getItem('token');
